      ...
      <Link to=':id' className='product-card position-relative'>
        ...
        <div className='product-details'>
            ...
            <h5 className='product-title'>
                Часы разных оттенков цветов для детей и студентов
            </h5>
            <ReactStars
               count={5}
               size={24}
            ...
            <p className={`description ${grid === 12 ? "d-block" : "d-none"}`}>
             Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam et est posuere, dignissim diam in, malesuada ante. Vivamus a felis rutrum, hendrerit neque eu, rutrum libero. Vivamus nisi urna, vestibulum id pretium nec, lobortis non metus.
            </p>
