...
const Home = () => {
        ...
        <div className='col-6'>
          <div className='main-banner position-relative'>
            ...
            <div className='main-banner-content position-absolute'>
              ...
              <h5>iPad S13+Pro.</h5>
              <p>От 550.000₸</p>
              <Link className='button'>Купить сейчас</Link>
            </div>
          </div>
        </div>
        <div className='col-6'>
 ...
 <div className='row'>
        <div className='col-12'>
          <h3 className='section-heading'>Избранная коллекция</h3>
        </div>
        <ProductCard/>
        <ProductCard/>
        <ProductCard/>
 ...
 <div className='row'>
        ...
        <div className='col-3'>
          <div className='famous-card position-relative'>
            ...
            <div className='famous-content position-absolute'>
            <h5 className='text-dark'>Новый</h5>
            <h6 className='text-dark'>MacBook Air M1</h6>
            <p className='text-dark'>27-дюймовый 5К Retrina дисплей</p>
            </div>
          </div>
        </div>
        <div className='col-3'>
          <div className='famous-card position-relative'>
            ...
            <div className='famous-content position-absolute'>
            <h5 className='text-dark'>Смартфоны</h5>
            <h6 className='text-dark'>iPhone 13 Pro.</h6>
            <p className='text-dark'>От 500.000₸</p>
            </div>
          </div>
        </div>
        <div className='col-3'>
          <div className='famous-card position-relative'>
            ...
            <div className='famous-content position-absolute'>
            <h5 className='text-dark'>Домашние колонки</h5>
            <h6 className='text-dark'>Лучшее звучание</h6>
            <p className='text-dark'>От 350.000₸</p>
            </div>
          </div>
        </div>
      </div>
  ...
  <Container class1='special-wrapper py-5 home-wrapper-2'>
      <div className='row'>
        <div className='col-12'>
          <h3 className='section-heading'>Специальные продукты</h3>
        </div>
      </div>
      <div className='row'>
        <SpecialProduct/>
  ...
  <Container class1='blog-wrapper py-5 home-wrapper-2'>
      <div className='row'>
        <div className='col-12'>
          <h3 className='section-heading'>Наши последние блоги</h3>
        </div>
      </div>
      <div className='row'>
        <div className='col-3'>
